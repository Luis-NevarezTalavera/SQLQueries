-- "ContentOwner_Name" = '"Charter"'
Select Count(*), Min("AssetID") as FirstAssetID, Max("AssetID") as LastAssetID, fileext, filewrapper,
VideoCODEC, "Display_A/R", width, height, "Frame_Rate", scantype, Max("Picture_A/R") as "Picture_A/R", Max("Picture_Format") as "Picture_Format",
AudioCODEC, bitdepth, samplerate, "Channel_Config", "Audio_Subtype", lower(audiolang) as audiolang, subtitletype, lower(subtitlelang) as subtitlelang
From (
	SELECT v."AssetID", "AssetUUID", filename, filesize, "Asset_Status", createddatetime, "TitleHRID", "CGID", "VersionID", "Version", titletype,
...
AudioCODEC, bitdepth, samplerate, "Channel_Config", "Audio_Subtype", audiolang, subtitletype, subtitlelang
	FROM (
		SELECT "AssetID", "AssetUUID", "Asset_Status", createddatetime, "TitleHRID", "CGID", "VersionID", "Version", titletype,
...
AudioCODEC, bitdepth, samplerate, "Channel_Config", "Audio_Subtype", lower(audiolang), subtitletype, lower(subtitlelang)
-- Having
Order by Count(*) desc
