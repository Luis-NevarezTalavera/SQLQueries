SELECT 
    ...
    E.Message,
    dateadd(hour, datediff(hour, getutcdate(), getdate()), E.CreatedDateTime) [CreatedDateTime]
FROM [OrderProcessing].[dbo].[DeliveryEvent] E with(nolock)
--where E.ContentID = '3765f2e6-2048-45b9-96d3-736e4f13c271'
order by E.CreatedDateTime asc
...
SELECT 
	...
	E.CustomerID,
	E.TitleID,
	E.DeliveryWorkflowRequest,
	dateadd(hour, datediff(hour, getutcdate(), getdate()), EM.CreatedDateTime) [CreatedDateTime]
...
SELECT TOP 1000 [CustomerPackageDataID]
      ,[CustomerID]
      ,[PackageData]
      ,[PackageType]
      ,[PackageID]
  ...
  WHERE PackageID = 'u/DEV/Assets/a1/C2/A7/a1-53454/s1-382277/a1-53454-s1-382263-v1-2001.M2TS' and
		PackageSubID = 'a1-53454'
